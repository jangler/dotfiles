...
globalkeys = gears.table.join(
    ...
    -- Media keys
    awful.key({}, "XF86AudioMute", function () awful.spawn('pactl set-sink-mute 6 toggle') end,
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.spawn('rofi -theme-str \'* { font: "Cousine 9"; }\' -show run') end,
    ...
    -- Prompt
    awful.key({ modkey,           }, "r", function () awful.spawn('rofi -theme-str \'* { font: "Cousine 9"; }\' -show run') end,
              {description = "run prompt", group = "launcher"}),
    awful.key({ modkey,          }, "w", function () awful.spawn('rofi -theme-str \'* { font: "Cousine 9"; }\' -show window') end,
              {description = "switch window prompt", group = "launcher"}),
