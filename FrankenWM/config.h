...
static key keys[] = {
    ...
    {  MOD4,             XK_h,          resize_master,     {.i = -50}},
    {  MOD4,             XK_l,          resize_master,     {.i = +50}},
    {  MOD4,             XK_o,          resize_stack,      {.i = -50}},
    {  MOD4,             XK_p,          resize_stack,      {.i = +50}},

    /* resize the borders */
    {  MOD4|CONTROL,     XK_u,          adjust_borders,    {.i = -2}},
    {  MOD4|CONTROL,     XK_i,          adjust_borders,    {.i = +2}},
    /* resize the useless gaps between the windows */
    {  MOD4|CONTROL,     XK_o,          adjust_gaps,       {.i = -8}},
    {  MOD4|CONTROL,     XK_p,          adjust_gaps,       {.i = +8}},
